...
<div class="page-header">
  ...
  <h1>TryHackMe</h1>
  <p>Writeups for TryHackMe rooms and challenges.</p>
</div>

<div class="card-grid">
  {% assign thm_writeups = site.writeups | where: "platform", "TryHackMe" | sort: 'date' | reverse %}
  ...
  {% else %}
  <div class="empty-state">No TryHackMe writeups yet.</div>
  {% endfor %}
</div>